...
export function buildDemoDashboard(period = '2026-07'): DashboardBootstrap {
  ...
  const plans = [
    { id:'P1', owner:'Đội QLHTĐĐ', title:'Rà soát điểm đo và nâng tỷ lệ kết nối/khai thác đo xa.', status, priority:'Cao' as const, deadline:status, objective:'Duy trì tỷ lệ kết nối và khai thác hóa đơn ổn định, giảm nhanh điểm mất kết nối kéo dài.', actions:['Phân nhóm điểm mất kết nối theo thời gian và hãng công tơ.','Ưu tiên xử lý điểm mất kết nối trên 48 giờ ảnh hưởng khai thác hóa đơn.','Đánh giá kết quả xử lý theo tuần.'], expectedResult:'Giảm backlog mất kết nối và tăng độ ổn định dữ liệu đo xa.', measure:'Tỷ lệ kết nối, tỷ lệ khai thác hóa đơn, số điểm mất kết nối >48h.' },
    { id:'P2', owner:'Đội QLVH', title:'Giảm sự cố trung thế, ưu tiên nguyên nhân có tỷ trọng cao.', status, priority:'Cao' as const, deadline:status, objective:'Giảm số vụ sự cố trung thế và bảo vệ chỉ tiêu SAIFI/SAIDI.', actions:['Khoanh vùng tuyến/TBA có sự cố lặp.','Ưu tiên xử lý nhóm nguyên nhân sét, động vật và cây.','Theo dõi hiệu quả giải pháp hằng tuần.'], expectedResult:'Giảm sự cố lặp và hạn chế thời gian mất điện khách hàng.', measure:'Số vụ sự cố, SAIFI, SAIDI và tỷ trọng nguyên nhân.' },
    { id:'P3', owner:'Phòng Kinh doanh', title:'Theo dõi điện thương phẩm, doanh thu và hợp đồng cần xử lý.', status, priority:'Trung bình' as const, deadline:status, objective:'Bám sát kế hoạch kinh doanh tháng và phát hiện sớm chỉ tiêu có xu hướng giảm.', actions:['Theo dõi TH/KH điện thương phẩm và doanh thu theo tuần.','Phân tích nhóm phụ tải biến động lớn.','Rà soát hồ sơ/hợp đồng có nguy cơ tồn hoặc quá hạn.'], expectedResult:'Giữ tiến độ điện thương phẩm, doanh thu và giảm tồn công việc kinh doanh.', measure:'TH/KH tháng, lũy kế, cùng kỳ và số hồ sơ tồn.' },
    { id:'P4', owner:'Khối ĐTXD', title:'Đẩy nhanh thực hiện, nghiệm thu và giải ngân các công trình.', status, priority:'Cao' as const, deadline:status, objective:'Bám tiến độ khối lượng thực hiện và giải ngân theo kế hoạch.', actions:['Rà soát công trình chậm tiến độ và nguyên nhân.','Ưu tiên hồ sơ nghiệm thu, thanh toán đủ điều kiện.','Cập nhật tiến độ thực hiện và giải ngân hằng tuần.'], expectedResult:'Tăng tỷ lệ hoàn thành ĐTXD/SCL và hạn chế dồn khối lượng cuối năm.', measure:'Giá trị thực hiện, giải ngân, tỷ lệ TH/KH.' },
    { id:'P5', owner:'Phòng TCNS', title:'Theo dõi năng suất lao động và kế hoạch đào tạo.', status, priority:'Bình thường' as const, deadline:status, objective:'Bảo đảm nguồn lực, năng suất lao động và tiến độ đào tạo theo kế hoạch.', actions:['Theo dõi NSLĐ theo kỳ.','Rà soát giờ đào tạo còn thiếu.','Ưu tiên chương trình đào tạo gắn với nhu cầu vận hành.'], expectedResult:'Hoàn thành kế hoạch đào tạo và duy trì NSLĐ theo mục tiêu.', measure:'NSLĐ, giờ đào tạo, tỷ lệ hoàn thành chương trình.' },
  ];
  return {
    ok:true,
    period:safePeriod,
